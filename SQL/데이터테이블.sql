...
CREATE TABLE `board` (
	...
	`bo_register_date`	datetime default now()	NULL,
	`bo_update_date`	datetime	NULL,
	`bo_views`	int default 0	NULL,
	`bo_up`	int default 0	NULL,
	`bo_down`	int default 0	NULL,
...
CREATE TABLE `board_type` (
	...
	`bt_type`	varchar(10)	NULL,
	`bt_name`	varchar(50)	NULL,
	`bt_r_autority`	int	NULL,
	`bt_w_autority`	int	NULL
);
