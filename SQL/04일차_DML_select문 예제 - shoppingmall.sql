...
-- 회원들을 아이디 순으로 오름차순으로 정렬하여 처음 2명만 조회
select * from member 
	order by me_id 
	limit 0, 2;
...
-- 개시글에서 조회수가 1이상 100이하인 게시글들을 조회
...
... where 속성명 like 문자열
- _ : 한 글자를 의미
... where bo_title like '___' : 제목이 3개짜리인 게시글들을 가져온다.
- % : 0글자 이상을 의미
