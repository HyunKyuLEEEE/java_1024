...
insert into genre(ge_name)
	values ('액션'),('어드벤처'),('SF'),('스릴러'),('드라마'),('뮤지컬'),('애니메이션'),('멜로/로맨스'),('느와르'),
				('미스테리'),('호러'),('판타지'),('서부'),('공포'),('컬트'),('다큐멘터리'),('코미디'),('가족'),('범죄'),
                ('전쟁'),('무협'),('에로'),('서스펜스'),('서사'),('블랙코미디'),('실험');
select * from genre;
...
insert into movie(mo_title, mo_contents, mo_age, mo_run, mo_opening_date, mo_state)
		values 
        ('아바타-물의길','<아바타: 물의 길>은 판도라 행성에서 ...', '12세 이상', 192, '2022-12-14', '현재 상영중');
select * from movie;        
-- 영화 장르 등록
...
insert seat(se_name, se_state, se_price, se_ci_num)values 
...
('A1', '사용가능', 10000, 3),('A2', '사용가능', 10000, 3),('A3', '사용가능', 10000, 3),
('A4', '사용가능', 10000 , 3),('A5', '사용가능', 10000 , 3),
('B1', '사용가능', 10000 , 3),('B2', '사용가능', 10000 , 3),('B3', '사용가능', 10000 , 3),
('B4', '사용가능', 10000 , 3),('B5', '사용가능', 10000 , 3),

('A1', '사용가능', 10000 , 4),('A2', '사용가능', 10000 , 4),('A3', '사용가능', 10000 , 4),
('B1', '사용가능', 10000 , 4),('B2', '사용가능', 10000 , 4),('B3', '사용가능', 10000 , 4),
('C1', '사용가능', 10000 , 4),('C2', '사용가능', 10000 , 4),('C3', '사용가능', 10000 , 4),('C4', '사용가능', 10000, 4),
...
-- 단 작업의 편의를 위해 18일 9:50분에 상영하는 아바타라는 정보대신 상영번호가 5번으로 활용
-- 예매
insert into ticketing(ti_amount, ti_total_price, ti_me_id, ti_ss_num)
	values(2, 20000, 'abc',5);
