...
public class CourseMapper implements CourseDAO{
	...
	public void insertLecture(LectureVO lecture) {
		String sql = "insert into lecture(le_name, le_schedule, le_point, le_class, le_year, le_term, le_pr_num) "
				+ "values(?,?,?,?,?,?,?)";
	...
	public void updateLecture(LectureVO lecture) {
		String sql = "update lecture set le_name = ?, le_schedule = ?, le_point = ?, le_class = ?, le_year = ?, le_term = ?, le_pr_num = ? "
				+ "where le_num = ?";
	...
	public LectureVO selectLectureByName(String le_name, int le_class, int le_year, String le_term) {
		String sql = "select le_num, le_name, le_schedule, le_point, le_class, le_year, le_term,"
				+ " le_pr_num from lecture where le_name = ? and le_class = ?"
				+ " and le_year = ? and le_term = ?";
