...
public class StringEx01 {
	...
	public static void main(String[] args) {
		 ...
		 * 		첫번째로 만나는 만나는 문자열/문자의 시작 번지 , 없는 경우 -1
		 ...
		 * 리터럴 문자열은 리터럴들만 모여있는 공간에 할당이 되는데, 같은 리터럴이 문자열이 있는
		...
		System.out.println("str1 과 str3가 같다? : " +(str1 == str3));
		System.out.println("str1 과 str2가 같다?(equals) : " +(str1.equals(str2)));
		System.out.println("str1 과 str3가 같다?(equals) : " +(str1.equals(str3)));
		...
		/* trim() : 시잔 문자 앞에 있는 공백을 제거하고 마지막 문자 뒤에 있는 공백을 제거함*/
		String str5 = "\n\n		\t안녕 하세요.\n\n";
